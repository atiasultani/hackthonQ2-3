...
'>
    ...
    <li><Link className='hover:underline hover:underline-offset-4' href="/"> Shop </Link></li>
...
'>
  ...
  className='bg-gray-200 bg-opacity-40   '/>
     ...
     <Link href='/cartSummary'> cart card</Link>
    ...
    <Link href="/product-list">product dynamic</Link>
    </div>
</div>
  )
}
