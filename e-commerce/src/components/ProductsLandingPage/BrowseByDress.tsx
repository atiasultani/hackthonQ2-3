  ...
  return (
    <div className="bg-gray-100 min-h-screen py-8">
      ...
      <div className="container mx-auto grid grid-cols-2 grid-rows-2 gap-6 px-4">
        {/* First Product */}
        <div className="bg-white border rounded-lg shadow-md grid grid-cols-2 grid-rows-2 items-center justify-center p-4 hover:shadow-lg transition-shadow">
          {product1 && product1.imageUrl && (
            <div className="w-full h-48 relative mb-4">
              <Image
                src={urlFor(product1.imageUrl).width(400).height(300).url()}
                alt={product1.title}
                fill
